...
public class Nav_draw_Fragment_Up_Tour extends Fragment implements DCHAUAdapta.OnNoteListener {


    private DatabaseReference ref;
    static ArrayList<HashMap> listUP, searchlist;
...
/*
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        DCHAUAdaptax = new DCHAUAdapta(listUP, this);
...
/*
       Intent intent=new Intent(getContext(),EmptyPage.class);
*/

        HashMap M = listUP.get(position);
        ...
        //   System.out.println("LAAAA  : "+CustomSwipeAdapter.image_res2.size() );


        //  System.out.println("0000"+M.values().toString());
    }
}
/*
