                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                  ...
                                  if(!MainActivity.getUser().isEmailVerified()){
                                      ...
                                      Toasty.info(SignInAsAgency.this.getApplicationContext(), "Verify Email first !",
                                 ...
                                 // setContentView(R.layout.empty_page);
                                    ...
                                    DatabaseReference d= FirebaseDatabase.getInstance().getReference("user/agency").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
                                      ...
                                      public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                          ...
                                          if(dataSnapshot.exists()){
                                             ...
                                             /* Toast.makeText(SignInAsAgency.this.getApplicationContext(), "Logged in ",
                                              ...
                                              Toasty.success(SignInAsAgency.this.getApplicationContext(), "Logged in ",
                                                      Toast.LENGTH_SHORT,true).show();
                                              ...
                                              MainActivity.traveleruser=false;
                                              MainActivity.agencyuser=true;
                                              startActivity(a);
                                              finish();
                                              finishActivity(0);
                                          }
                                            ...
                                            ///  setContentView(R.layout.activity_signinas_agency);
                                             /* Toast.makeText(SignInAsAgency.this.getApplicationContext(), "You have signed up a Traveler .Try Sign in as Traveler instead",
                                                      Toast.LENGTH_SHORT).show();*/

                                              Toasty.error(SignInAsAgency.this.getApplicationContext(), "You have signed up a Traveler .Try Sign in as Traveler instead",
                                                      Toast.LENGTH_SHORT,true).show();

                                               FirebaseAuth.getInstance().signOut();
                                               progressBar.setVisibility(View.GONE);
                                               //SignInAsAgency.super.onBackPressed();
                                          }
                                      }
