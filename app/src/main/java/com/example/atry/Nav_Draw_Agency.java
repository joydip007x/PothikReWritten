...
public class Nav_Draw_Agency extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, DExitApp.DExitAppLis {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      ////  System.out.println(" LALALA "+ FirebaseInstanceId.getInstance().getToken() );
        ...
        DatabaseReference dr=FirebaseDatabase.getInstance().getReference("user/agency").child(FirebaseAuth.getInstance().getUid());
